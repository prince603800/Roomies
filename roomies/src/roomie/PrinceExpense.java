...
/**
 * Servlet implementation class PrinceExpense
 */
@WebServlet("/PrinceExpense")
public class PrinceExpense extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrinceExpense() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("<table>");
			out.print("<h1>Expenses Prince</h2>");
