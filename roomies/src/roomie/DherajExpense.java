...
/**
 * Servlet implementation class DherajExpense
 */
@WebServlet("/DherajExpense")
public class DherajExpense extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DherajExpense() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("</head>");
			out.print("<h1>Expenses Dheraj</h2>");
			out.print("<table>");
